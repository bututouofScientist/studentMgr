...
urlpatterns = [
    ...
    path('add/', student_views.add_values, name='add_student'),
    path('edit/', student_views.edit_values, name='edit_student'),
    path('del/', student_views.del_values, name='del_student'),
]
